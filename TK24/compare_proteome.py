...
blastResTemp = "tmp.blastout"


blastpCmd = NcbiblastpCommandline(query=protsFasta, db=dbName, outfmt=5, out=blastResTemp, num_threads=os.cpu_count(),
...
with open(tableOut, 'w') as outHandle:
    ...
    with open(blastResTemp, 'r') as resHandle:
